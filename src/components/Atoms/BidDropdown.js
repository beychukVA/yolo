...
import { SingleContentToggle } from './SingleContentToggle'
import { bucketsLevelIconText } from './BucketLevelIcon'
    ...
    return options?.map((option, idx) => {
      return (
        <SingleContentToggle
          ...
          falseContent={
            <SelectOption value={option.id}>
              {bucketsLevelIconText[option.level]} {option.caption}
            </SelectOption>
          }
        />
      )
