...
export const G3minPredictView = memoThis(({ gamePool, potentialGain, myBids = [] }) => {
    ...
    <Container>
      ...
      {useMemo(
        () => (
          <>
            <SectionPayout>
              <TotalPayoutHeading hasBids={hasBids} isUp={isUp}>
                Total Payout
              </TotalPayoutHeading>
        ...
        // eslint-disable-next-line
        [myUpTotal, myDownTotal, hasBids, isUp, showPayout]
      )}
    </Container>
  )
})
