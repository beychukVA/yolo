...
export const PageWrapper = styled.div`
  ...
  #level_5 form {
    ...
    position: relative;
    z-index: 1;
    box-shadow: 0 0 85px 0px rgba(0, 0, 0, 0.5);
    -webkit-box-shadow: 0 0 85px 0px rgba(0, 0, 0, 0.5);
    -moz-box-shadow: 0 0 85px 0px rgba(0, 0, 0, 0.5);
    border-radius: 15px;
  }
  #level_5 form input {
    padding: 10px 25px;
  ...
  #level_6 ul li.pantera .logo {
    background: url(${landingAssets.pantera_cap_logo_color_circle}) center center/auto 60px no-repeat;
  }
  #level_6 ul li.pantera:hover .logo {
    background: url(${landingAssets.pantera_cap_logo_color_circle}) center center/auto 60px no-repeat;
  }
  #level_6 ul li.cluster .logo {
    background: url(${landingAssets.cluster_color_circle}) center center/auto 60px no-repeat;
  }
  #level_6 ul li.cluster:hover .logo {
    background: url(${landingAssets.cluster_color_circle}) center center/auto 60px no-repeat;
  }
  #level_6 ul li.lemniscap .logo {
    background: url(${landingAssets.lemniscap_logo_color}) center center/auto 40px no-repeat;
    width: 250px;
  }
  ...
  #level_6 ul li.deepventures .logo {
    background: url(${landingAssets.deepventures_color_circle}) center center/auto 60px no-repeat;
  }
  #level_6 ul li.deepventures:hover .logo {
    background: url(${landingAssets.deepventures_color_circle}) center center/auto 60px no-repeat;
  }
  #level_6 ul li.angeldao .logo {
    background: url(${landingAssets.angeldao_logo_color}) center center/auto 45px no-repeat;
    width: 200px;
  }
  ...
  #level_6 ul li.kretos .logo {
    background: url(${landingAssets.kretos_logo}) center center/auto 58px no-repeat;
    width: 100px;
  }
