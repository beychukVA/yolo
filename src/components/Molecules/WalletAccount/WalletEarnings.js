...
export const WalletEarnings = () => {
  //@TODO: Need to get yoloEarnings information from backend
  const { toCryptoAmount, toFiatAmount } = useUnitConvert()
  ...
  const earnings = useMemo(() => {
    ...
    return {
      issuance: {
        ...
        cryptoAmount: toCryptoAmount(yoloEarnings, DEFAULT_TOKEN),
        fiatAmount: toFiatAmount(yoloEarnings, DEFAULT_TOKEN)
      },
      participation: {
      ...
      total: {
        ...
        cryptoAmount: toCryptoAmount(earningsTotal, DEFAULT_TOKEN),
        fiatAmount: toFiatAmount(earningsTotal, DEFAULT_TOKEN)
      }
    }
  }, [yoloEarnings, toCryptoAmount, toFiatAmount])
  ...
  return (
    <EarningsWrapper>
      ...
      <TxListContent>
        <TxRow>
          <StatusWrapper>
            <Status>{earnings.issuance.description}</Status>
            <InfoWrapper>
        ...
        <TxRow>
          <StatusWrapper>
            <Status>{earnings.participation.description}</Status>
            <InfoWrapper>
        ...
        <EarningsTotal>
          <StatusWrapper>
            <Status>{earnings.total.description}</Status>
            <InfoWrapper>
