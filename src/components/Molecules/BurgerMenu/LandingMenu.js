...
export const LandingMenu = ({ open }) => {
  /* prettier-ignore */
  const MENU_ITEMS = [
    { id: 'xft', label: 'XFT', icon: 'xftFramed', collection: 'general', to: '/game/yoloxft' },
    { id: 'about', label: 'About', icon: 'about', collection: 'general', to: '/about' },
    { id: 'press', label: 'Press', icon: 'press', href: 'https://docs.yolorekt.finance/press-and-media' },
