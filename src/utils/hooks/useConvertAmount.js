...
const HARD_CODED_RATES = {
  ...
  USDC: { network: 'Polygon', currentPrice: 1, symbol: 'USDC' }
}

const CURRENCIES = {
  fiats: Object.values(FIAT),
  cryptos: Object.values(TOKEN)
}

//TODO: ACZ - Improve this hook using atom/jotai
