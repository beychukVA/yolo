{
  const LiquidButton = class LiquidButton {
    constructor(optionsParam) {
      ...
      this.color1 = options.color1 || '#DE0E54'
      this.color2 = options.color2 || '#1D4BAF'
      this.color3 = options.color3 || '#598DFF'
      ...
      this.wrapperElement = document.getElementById('play_button') || document.body
    ...
    draw() {
      ...
      this.context.font = '500 ' + (this.height - this.padding * 2) + 'px Inter'
